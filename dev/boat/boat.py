...
class Boat( mechanical.MechanicalSystemWithPositionInputs ):
    """ 
    Equations of Motion
    -------------------------
    ...
    def __init__(self):
        ...
        # Labels
        self.name = '2D planar boat model'
        ...
        # State working range
        self.x_ub = np.array([+50,+50,+3,+2,+2,+1])
        self.x_lb = np.array([-50,-50,-3,-2,-2,-1])
        
        # State working range
        self.u_ub = np.array([+500,+1])
        self.u_lb = np.array([-10,-1])
        
        # Model param
        self.mass           = 1000
        self.inertia        = self.mass * 0.3 ** 2
        self.ycg            = 1
